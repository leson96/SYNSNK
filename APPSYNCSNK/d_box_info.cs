...
namespace APPSYNCSNK
{
    ...
    public partial class d_box_info
    {
        public int bxno { get; set; }
        public string bx_no { get; set; }
        public string bx_nm { get; set; }
        public Nullable<int> tr_qty { get; set; }
        public Nullable<int> try_mapping_qty { get; set; }
        public Nullable<int> prd_mapping_cnt { get; set; }
